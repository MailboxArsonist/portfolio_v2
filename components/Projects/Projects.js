...
export default function Projects() {
    ...
    const Projects = projects.map(({title, text, src, buttonText, alt}, index) => (
        <ProjectCard 
            openModal={openModal} 
            title={title} 
            text={text} 
